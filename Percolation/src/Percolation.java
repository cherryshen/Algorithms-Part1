...
public class Percolation {
    ...
    private WeightedQuickUnionUF unionFindTop;
    ...
    public Percolation(int n) {
        ...
        this.unionFindTop = new WeightedQuickUnionUF(n * n + 2);
        this.topRow = 0;
    ...
    public void open(int i, int j) {
        ...
        if (i == 1) {
            ...
            unionFindTop.union(axisToIndex(i, j), topRow);
        }
        if (i == this.gridSize) {
    ...
    public boolean isFull(int i, int j) {
        this.validateInput(i, j);
        return this.isOpen(i, j) && unionFindTop.connected(axisToIndex(i, j), topRow);
    }
     ...
     * @return
     */
    private int axisToIndex(int i, int j) {
    ...
    private void validateInput(int i, int j) {
        if (i < 1 || j < 1) {
            throw new IndexOutOfBoundsException("i, j must be > 0");
        }
    }
